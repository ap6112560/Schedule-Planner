...
If Label3.Caption = "Wednesday" Then
Thursday.Show
...
Adodc1.RecordSource = "Select * FROM WED ORDER BY start ASC"
Adodc1.Refresh
If y = 0 Then
y = 1
...
x = 0
For Each frm In Forms
If Not frm.Name = "Wednesday" Then
Unload frm
End If
Next
Thursday.Show
